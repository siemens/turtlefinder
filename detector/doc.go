...
supported out-of-the-box of this module. The individual engine-specific detector
plugins are then implemented in the other sub-packages: for instance, the
“containerd” and “moby” sub-packages.
*/
package detector
